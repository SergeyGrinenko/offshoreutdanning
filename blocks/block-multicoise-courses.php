...
$posts_id = get_field('choose_courses');
...
<div class="grouped_multi_courses">
    <?php $i = 0; ?>
                ...
                <?php else: ?>
                    ...
                    <?php if ($i === 0): ?>
                        <div class="location pb-2">
                            <select class="choose-location" data-ids="<?php echo implode(",", $posts_id); ?>"
                                    data-from="<?php echo $date_from; ?>" data-to="<?php echo $date_to; ?>">
                                    ...
                                    foreach ($values as $val) { ?>
                                        <div class="practic_type__item" data-attr-term="<?php echo $val->name; ?>">
                                            <label for="<?php echo $post_id; ?>_<?php echo $val->term_id; ?>"><?php echo $val->name; ?>
                                                <input type="radio"
                                                       id="<?php echo $post_id; ?>_<?php echo $val->term_id; ?>"
                    ...
                    <div class="grouped_multi_course_wrap promo_item" data-post-id="<?php echo $post_id; ?>">
